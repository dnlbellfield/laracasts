    ...
    <div class="md:hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
        ...
        <x-nav-link-mobile href="/" :active="request()->is('/')">Home</x-nav-link-mobile>
              ...
              <x-nav-link-mobile href="/contact" :active="request()->is('contact')" type="button">Contact</x-nav-link-mobile>
      ...
      <div class="border-t border-gray-700 pb-3 pt-4">
        <div class="flex items-center px-5">
          ...
          <div class="ml-3">
            <div class="text-base font-medium leading-none text-white">Daniel Bellfield</div>
            <div class="text-sm font-medium leading-none text-gray-400">dnlbellfield@gmail.com</div>
          </div>
